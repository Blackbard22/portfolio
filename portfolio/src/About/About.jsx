...
const About = () => {
    ...
    const add_arrow = () => {
        ...
        if (arrow) {
            arrow.className = `${styles.arrow} ${styles.active}`;
        }
    }
    ...
    const info_section = document.querySelector(`.${styles.info_section}`);
    if (info_section) {
        info_section.addEventListener('mouseenter', add_arrow);
        info_section.addEventListener('mouseleave', remove_arrow);
    }
        ...
        <div className={styles.container}>
            ...
            <div className={styles.contentContainer}>
                ...
                <div className={styles.info_section}>
                    <div className={styles.info_top_banner} >
                        <Link to="/">
                            <svg
                    ...
                    <div className={styles.mailBox}>
                        ...
                        <div>
                            ...
                            <p className={styles.email} onMouseEnter={add_arrow} onMouseLeave={remove_arrow}> hosnimohammedom@gmail.com</p>
