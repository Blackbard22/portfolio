...
import image2 from '../../public/maze1.png';
import image1 from '../../public/maze2.png';
import image3 from '../../public/maze3.png';
...
const ProjectView = () => {
    ...
    const itemRefs = useRef(['Django', "React", "Huey_Scheduling"]);
            ...
            <div className={styles.contentWrapper} ref={contentWrapperRef}>
                            ...
                            <div className={styles.proj_grid}>
                                <div className={styles.proj_title}>
                                    ...
                                    <div className={styles.proj_summary}>
                                        visualizing an agent trying to traverse an interactive maze using simple algorithms
                                    </div>
                                </div>
                ...
                <div className={styles.image_grid} >
                    <div className={styles.grid_image_1}>
                        <img src={image1} alt="" />
                        <div className={`${styles.grid_image_text} ${styles.first_image}`}>
                            <p>
                                Q-table and position updates while algorithm is running
                            </p>
                        </div>
                    </div>
